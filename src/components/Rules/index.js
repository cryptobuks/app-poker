...
const Rules = () => (
  <div className="rules">
    ...
    <p className="last-update">Atualizado em: 10/abril/2017</p>

    <p><span className="number">1.</span> O torneio será realizado quinzenalmente, a partir do dia 29/09;</p>
    ...
    <p><span className="number">3.</span> Teremos time chip de 2k fichas para quem chegar até as 21:00hs, após esse horário o jogador receberá stack normal de 6k fichas, independentemente se o torneio já começou ou não;</p>
    ...
    <p><span className="number">5.</span> Após o término do sexto nível, serão jogadas mais 3 mãos. Ao término desse nível não será permitido mais rebuy, o jogador permanecerá com a quantidade de fichas que terminou o nível;</p>
    ...
    <br />6k iniciais = R$30,00
    <br />BLINDS: TEMPO:
    <br />25/50 20min
    <br />50/100 20min (40 min de jogo)
    <br />75/150 20min (1 hora de jogo)
    <br />100/200 20min (1 hora e 20min de jogo)
    <br />150/300 20min (1 hora e 40min de jogo)
    <br />200/400 20min (2 horas de jogo)
    <br />250/500 15min (2 horas e 15min de jogo)
    <br />300/600 15min (2 horas e 30min de jogo)
    <br />350/700 15min (2 horas e 45min de jogo)
    <br />400/800 15min (3 horas de jogo)
    <br />450/900 15min (3 horas e 15min de jogo)
    <br />500/1k 15min (3 horas e 30 min de jogo)
    <br />750/1,5k 15 min (3 horas e 45min de jogo)
    <br />1k/2k 15min (4 horas de jogo)
    <br />1,5k/3k 15 min (4 horas e 15min de jogo)
    <br />2k/4k 15min (4 horas e 30min de jogo)
    <br />3k/6k 15min (4 horas e 45min de jogo)
    <br />4k/8k 15min (5 horas de jogo)
    <br />5k/10k 15min (5 horas e 15min de jogo)
    <br />6k/12k 15 min (5 horas e 30min de jogo)
    </p>
